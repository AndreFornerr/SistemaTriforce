...
public class Arquivo {
    ...
    final private String nomeArqVenda = "venda.dat";
    ...
    public Arquivo() {
        ...
        arquivoVenda = new File(nomeArqVenda);
    }
    ...
    public Map getVenda() {
        ...
        if (arquivoVenda.exists()) {
            try {
                venda = (Map) new ObjectInputStream(new FileInputStream(arquivoVenda)).readObject();
            } catch (IOException | ClassNotFoundException ex) {
                Logger.getLogger(Arquivo.class.getName()).log(Level.SEVERE, "Ler Arquivo Pedido", ex);
            }
        } else {
    ...
    public void salvarVenda(Map mp) {
        try {
            new ObjectOutputStream(new FileOutputStream(arquivoVenda)).writeObject(mp);
        } catch (IOException ex) {
            Logger.getLogger(Arquivo.class.getName()).log(Level.SEVERE, "Salvando arquivo", ex);
        }
