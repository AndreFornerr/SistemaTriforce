 ...
 * @author l147033
 */
public class ControleEstoque extends Geral {
    ...
    public ControleEstoque(ProdutoEstoque prod, CodigoExcluidoRegistro ex) {
        initComponents();
        this.prod = prod;
        this.ex = ex;
        model = new ProdutoTableModel(prod);
        tab_estoque.setModel(model);
    }
    ...
    private void btn_confirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_confirmarActionPerformed
        ...
        if (prod.verificaKey(Integer.parseInt(txt_produto.getText())) == 1
                && txt_Qtd.getText().length() > 0) {

            if (rad_adicionar.isSelected()) {

                prod.setSaldo(Integer.parseInt(txt_produto.getText()), prod.getSaldo(Integer.parseInt(txt_produto.getText())) + Integer.parseInt(txt_Qtd.getText()));
                model = new ProdutoTableModel(prod);
            ...
            if (rad_remover.isSelected()) {
                if (prod.getSaldo(Integer.parseInt(txt_produto.getText())) - Integer.parseInt(txt_Qtd.getText()) >= 0) {
                    prod.setSaldo(Integer.parseInt(txt_produto.getText()), prod.getSaldo(Integer.parseInt(txt_produto.getText())) - Integer.parseInt(txt_Qtd.getText()));
