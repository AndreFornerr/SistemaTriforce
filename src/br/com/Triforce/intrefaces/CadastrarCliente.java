 ...
 * @author l147033
 */
public class CadastrarCliente extends Geral {
    ...
    public CadastrarCliente(ClienteRegistro cliReg, CodigoExcluidoRegistro ex) {
        initComponents();
        this.setLocationRelativeTo(null);
        txt_cod.setText(Integer.toString(cliReg.retornaMap() + 1 + ex.getCli(0)));
    ...
    private void btn_cadastrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_cadastrarMouseClicked
        ...
        if (txt_nome.getText().length() > 0
            ...
            cliReg.adicionaCli(cliReg.retornaMap() + 1 + ex.getCli(0),
                    txt_nome.getText(),
                    txt_rg.getText(),
                    txt_cpf.getText(),
                    txt_email.getText(),
