 ...
 * @author l147033
 */
public class CadastrarFuncionario extends Geral {
    ...
    public CadastrarFuncionario(FuncionarioRegistro funcReg, CodigoExcluidoRegistro ex) {
        initComponents();
        this.funcReg = funcReg;
        this.ex = ex;
        this.setLocationRelativeTo(null);

        txt_cod.setText(Integer.toString(funcReg.retornaMap() + 1 + ex.getFunc(0)));
    ...
    private void btn_gravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_gravarActionPerformed
        ...
        if (txt_nome.getText().length() > 0
            ...
            funcReg.adicionaFunc(funcReg.retornaMap() + 1 + ex.getFunc(0),
                    txt_nome.getText(),
                    txt_rg.getText(),
                    txt_cpf.getText(),
                    txt_email.getText(),
