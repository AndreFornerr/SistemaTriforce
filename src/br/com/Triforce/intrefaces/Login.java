...
public class Login extends javax.swing.JFrame {
    ...
    public Login(ProdutoEstoque prod, FornecedorRegistro forReg, FuncionarioRegistro funReg, ClienteRegistro cliReg, PedidoRegistro reg, CodigoExcluidoRegistro ex, VendaRegistro vend) {
        initComponents();
    ...
    private void btn_EntrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_EntrarMouseClicked
        ...
        if (txt_User.getText().equals(getLoginAdmin()) && psd_Senha.getText().equals(getLoginAdmin())
                || funReg.verificaKey(Integer.parseInt(txt_User.getText())) == 1 && funReg.getSenha(Integer.parseInt(txt_User.getText())).equals(psd_Senha.getText())) {
            JOptionPane.showMessageDialog(rootPane, "Bem Vindo!!");
            this.dispose();
            new Principal(prod, forReg, funReg, cliReg, reg, ex, vend).setVisible(true);
        } else {
    ...
    public static void main(String args[]) {
        ...
        final VendaRegistro g = new VendaRegistro();

        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Login(a, b, c, d, e, f, g).setVisible(true);
            }
        });
    }
