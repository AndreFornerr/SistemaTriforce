...
public class FuncionarioRegistro implements Serializable {
    ...
    public void adicionaFunc(int codigo, String nome, String rg, String cpf, String email, String telefone, String endereco, String senha) {
    ...
    public int verificaKey(int cod) {
    ...
    public void removeMap(int cod) {
        funcionarios.remove(cod);
    }

    public int verificaValue(String value) {
        if (funcionarios.containsValue(value) == true) {
            return 1;
        } else {
            return 0;
        }
